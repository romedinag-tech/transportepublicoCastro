...
window.CITY = {
  ...
  nombre: "Castro",
  sigla: "C",
  lat0: -42.4713, lon0: -73.7794,
  comunas: ["Castro"],
  comunasGeojson: "comunas_castro.geojson",
  live: true,
  liveBase: "https://storage.googleapis.com/castro-transporte-live/",
  demanda: false,
  repo: "transportepublicoCastro",
